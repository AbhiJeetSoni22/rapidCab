...
const ConfirmRide = (props) => {
  return (
    <div>
     <h2 className="text-xl font-semibold md:text-3xl mb-1 ">Confirm You Ride</h2>
            <div
            ...
            <div className="flex gap-2 justify-between items-center flex-col ">
              ...
              <div className='w-full'>
                ...
                <button onClick={()=>{
                    ...
                    props.setConfirmRidePanel(false)
                    props.createRide()
                }} className='w-full   md:py-3 md:px-4 md:w-1/2 bg-green-600 text-white font-medium py-2 px-4 rounded-lg'>Confirm</button>
